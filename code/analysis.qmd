...
- Import `data/coretta2018/token-measures.csv`. You can find information about the data here: <https://uoelel.github.io/dal/data/coretta2018/token-measures.html>.
- Create the following plots. For each, customise labels and add a description.
